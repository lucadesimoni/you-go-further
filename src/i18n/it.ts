...
export const it: Dictionary = {
  ...
  "privacy.onServer": "salvato sulla piattaforma",
  "privacy.onDevice": "salvato in questo browser",
  "privacy.lead": "Questa app conserva dati vicini alla salute su di te — peso, frequenza cardiaca, quanto sudi e ogni percorso che hai corso. Qui c'è esattamente cosa sono, chi altro li vede e come portarli via o farli cancellare.",
  "privacy.whatWeHold": "Cosa conserviamo",
  "privacy.itemAccount": "Il tuo account",
  "privacy.itemAccountWhy": "Nome e indirizzo e-mail, perché il piano sia tuo su ogni dispositivo.",
  "privacy.itemBody": "Dati corporei e di salute",
  "privacy.itemBodyWhy": "Peso, frequenza cardiaca massima, tasso di sudorazione e sodio, prontezza. È ciò che rende un piano tuo invece di una media.",
  "privacy.itemTraining": "I tuoi allenamenti",
  "privacy.itemTrainingWhy": "Le sessioni importate dai servizi che colleghi: percorsi GPS, durata, frequenza cardiaca e dislivello.",
  "privacy.itemLogs": "Registri delle sessioni",
  "privacy.itemLogsWhy": "Com'è andata la sessione — tolleranza gastrica, energia, cosa hai davvero preso. È ciò da cui il pianificatore impara.",
  "privacy.whereItGoes": "Dove va",
  "privacy.whereLead": "La piattaforma e il suo database girano su infrastruttura svizzera. Quattro cose la lasciano comunque, ed è elencata ognuna invece di nasconderla:",
  "privacy.tpProviders": "Strava, Garmin, Polar, Suunto —",
  "privacy.tpProvidersWhy": "solo se li colleghi. Le tue sessioni vengono da lì, quindi il rapporto è con loro tanto quanto con noi.",
  "privacy.tpGeo": "swisstopo e MeteoSvizzera —",
  "privacy.tpGeoWhy": "le coordinate del percorso che stai guardando, per terreno e meteo. Servizi federali svizzeri; i dati restano in Svizzera.",
  "privacy.tpTiles": "Tessere della mappa —",
  "privacy.tpTilesWhy": "la porzione di mappa a schermo viene richiesta all'host delle tessere, fuori dalla Svizzera se l'operatore non la ospita in proprio.",
  "privacy.tpMail": "Il fornitore di posta —",
  "privacy.tpMailWhy": "il tuo indirizzo e il link di accesso, quando entri via e-mail.",
  "privacy.noAds": "Nessuna pubblicità, nessun pixel di tracciamento, nessun profilo analitico. Nulla viene venduto.",
  "privacy.yourRights": "I tuoi dati, la tua scelta",
  "privacy.rightsLead": "Entrambi agiscono subito e non dipendono dal tuo abbonamento — una copia dei propri dati è un diritto, non una funzione.",
  "privacy.exportMine": "Scarica tutto ciò che conserviamo",
  "privacy.deleteMine": "Elimina il mio account",
  "privacy.exported": "I tuoi dati sono stati scaricati.",
  "privacy.exportFailed": "Non è stato possibile creare l'export. Riprova.",
  "privacy.deleteConfirmTitle": "Eliminare il tuo account?",
  "privacy.deleteConfirmBody": "Sessioni, registri, profilo corporeo e collegamenti verranno cancellati. È irreversibile — scarica prima una copia, se ne vuoi una.",
  "privacy.deleteConfirm": "Elimina tutto",
  "privacy.deleted": "Il tuo account e i suoi dati sono stati eliminati.",
  "privacy.deleteFailed": "Non è stato possibile eliminare l'account. Non è stato rimosso nulla.",
  "privacy.retainNote": "Un'eccezione, detta chiaramente: gli ordini pagati restano come documenti contabili, perché un'azienda è tenuta a conservarli. Non sono più collegati a un account.",
  "privacy.operator": "Chi gestisce il servizio",
  "privacy.operatorTodo": "Il nome legale dell'operatore, l'indirizzo e il contatto per la protezione dei dati vanno qui, insieme ai termini a cui rimanda la schermata di accesso. Non sono ancora compilati, e inventarli sarebbe peggio che lasciarli vuoti — un deployment deve aggiungerli prima di accettare account reali.",
  "privacy.operatorContact": "Contatto protezione dei dati:",
  "privacy.operatorTerms": "Termini di servizio",
  ...
  "common.showRest": "Mostra altri {count}",
  "common.showRest_one": "Mostra 1 altro",
  ...
  "plan.viewsLabel": "Quale parte del piano",
  "plan.view.plan": "Il piano",
  "plan.view.fuel": "Cosa portare",
  "plan.view.learn": "Dettagli e diario",
  "plan.house": "propria",
  ...
  "log.samplesLogged": "{count} registrate",
  "log.carbCeiling": "tetto {n} g/h",
  "log.targetsUnchanged": "obiettivi invariati",
  "log.clear": "Azzera",
  ...
  "map.layers": "Livelli",
  "map.baseMap": "Mappa di base",
  "map.overlays": "Mostra sopra",
  "map.layerUnavailable": "Non disponibile al momento",
  ...
  "insights.milestonesAhead": "{count} ancora da raggiungere",
  "insights.noSessions":
  ...
  "connect.brings": "Porta {what}",
  "cap.activities": "sessioni",
  "cap.heartRate": "frequenza cardiaca",
  "cap.power": "potenza",
  "cap.trainingLoad": "carico di allenamento",
  "cap.sleep": "sonno",
  ...
  "route.title": "Un percorso, e come alimentarlo",
  "route.intro": "Dove assumere carboidrati su questo percorso, posizionati secondo il terreno — scegli uno dei tuoi percorsi registrati o importane uno.",
  "route.source": "Quale percorso",
  "route.sourceSynced": "Dalle tue sessioni",
  "route.sourceImport": "Importa un percorso",
  "route.verticalScale": "altezza ×{factor}",
  ...
  "landing.title": "I tuoi dati di allenamento, tradotti in un piano nutrizionale",
  "landing.lede": "Garmin, Strava, Polar e Suunto misurano quello che hai fatto. I marchi vendono quello che ingerisci. In mezzo manca uno strato: grammi all'ora, millilitri, sodio — calcolati per il tuo corpo, la tua sessione e la settimana che hai alle spalle.",
  "landing.proofBody": "Peso, frequenza cardiaca, sudorazione misurata e meteo — non una media di popolazione.",
  "landing.proofLoad": "Le tue ultime sei settimane di carico plasmano il piano, non solo la sessione di oggi.",
  "landing.proofProducts": "Abbinato a prodotti veri acquistabili in Svizzera, senza preferenze di marca.",
  "landing.providers": "Importa da {count} piattaforme — Garmin, Strava, Polar e Suunto.",
  "landing.chainTitle": "Dove ci collochiamo",
  "landing.chainLede": "La catena del valore dell'endurance ha tre anelli. Due sono già occupati.",
  "landing.chainMeasure": "Misurare",
  "landing.chainMeasureWhat": "Il tuo orologio, e le piattaforme dietro di esso",
  "landing.chainDecide": "Decidere",
  "landing.chainDecideWhat": "Cosa mangiare e bere, e quando — questo siamo noi",
  "landing.chainSupply": "Fornire",
  "landing.chainSupplyWhat": "I marchi che producono i gel e le bevande",
  "landing.offerTitle": "Cosa ottieni",
  "landing.offerLede": "Quattro cose che l'app fa davvero oggi.",
  "landing.offerPlanTitle": "Un piano in grammi, non in aggettivi",
  "landing.offerPlanBody": "Carboidrati all'ora, liquidi all'ora e sodio per litro per la sessione che hai davanti — con il ragionamento, se lo vuoi vedere.",
  "landing.offerCuesTitle": "Un programma da seguire durante la sessione",
  "landing.offerCuesBody": "Promemoria a tempo — 0:20, 15 g di carboidrati, 140 ml — con un orologio che evidenzia quello in scadenza.",
  "landing.offerRouteTitle": "Il percorso, e quanto ti costa",
  "landing.offerRouteBody": "Importa un GPX o una gara svizzera: salite, caldo e quota cambiano il piano, e i rifornimenti cadono dove sta la fatica.",
  "landing.offerLearnTitle": "Impara cosa tollera il tuo intestino",
  "landing.offerLearnBody": "Annota com'è andata una sessione e gli obiettivi si spostano. Novanta grammi all'ora sono un tetto, non una prescrizione.",
  "landing.engineTitle": "Su cosa ragiona il motore",
  "landing.engineLede": "Due delle idee dietro ogni piano, dagli stessi numeri con cui lavora l'app.",
  "landing.curveTitle": "Carboidrati disponibili in una sessione lunga",
  "landing.curveAlt": "Un grafico a linee: alimentata secondo il piano la curva resta alta, con la sola acqua scende sotto il limite.",
  "landing.curveFuelled": "Alimentato secondo il piano",
  "landing.curveWater": "Solo acqua",
  "landing.curveLimit": "Quando il serbatoio è vuoto",
  "landing.ladderTitle": "Carboidrati all'ora, per durata",
  "landing.ladderShort": "Sessione breve, meno di 45 min",
  "landing.ladderMid": "Fino a 75 min",
  "landing.ladderLong": "Da una a due ore e mezza",
  "landing.ladderUltra": "Oltre le 2,5 ore",
  "landing.ladderNote": "Grammi all'ora. Il limite è l'assorbimento, non la volontà — e si allena.",
  "landing.articlesTitle": "Una guida che dice i numeri",
  "landing.articlesLede": "{count} articoli: cosa fare, quanto, cosa va storto più spesso e da dove viene l'indicazione.",
  "landing.closeTitle": "Inizia dalla sessione di domani",
  "landing.closeBody": "Nessuna carta, nessuna telefonata commerciale. Collega una piattaforma o inserisci una sessione, e guarda il piano.",
  "landing.closeCta": "Crea il tuo account",
  "landing.footNoOperator": "Questa installazione non indica alcun gestore.",
  "landing.footNote": "Indicazioni generali per adulti sani, secondo il consenso corrente in nutrizione sportiva. Non è un parere medico.",
  ...
  "toast.planningRace": "Pianificazione per questa gara — la sessione qui sotto si adatta.",
  ...
  // ---- Training plan ------------------------------------------------------
  "train.title": "Piano di allenamento",
  "train.intro": "Una progressione fino al giorno di gara, a partire dal tuo allenamento di oggi. Sposta le sedute come ti serve — è un modello, non un allenatore.",
  "train.fromMeasured": "Costruito sulle tue {hours} h a settimana delle ultime sei settimane.",
  "train.fromAssumed": "Nessuna seduta sincronizzata, quindi il piano parte volutamente basso a {hours} h a settimana. Collega un servizio e partirà dal tuo volume reale.",
  "train.peak": "Picco a {hours} h a settimana",
  "train.longest": "Seduta più lunga {time}",
  "train.rehearse": "{carb} g/h provati entro la settimana di gara",
  "train.tooShort": "Resta poco tempo per costruire. Questo è ciò che ci sta — parti con la forma che hai invece di rincorrere.",
  "train.week": "Settimana {n}",
  "train.weeksOut": "mancano {n} settimane",
  "train.weeksOut_one": "manca {n} settimana",
  "train.raceWeekLabel": "Settimana di gara",
  "train.hoursShort": "{n} h",
  "train.showAll": "Mostra tutto il piano ({n} settimane)",
  "train.showLess": "Mostra solo le prossime settimane",
  "train.disclaimer": "Un modello basato sulla pratica corrente dell'allenamento di resistenza. Conosce il tuo volume e la tua gara, non i tuoi infortuni né il tuo calendario.",
  "train.phase.base": "Base",
  "train.phase.build": "Costruzione",
  "train.phase.peak": "Specifico",
  "train.phase.taper": "Scarico",
  "train.phase.raceWeek": "Settimana di gara",
  "train.kind.rest": "Riposo",
  "train.kind.easy": "Lento",
  "train.kind.quality": "Qualità",
  "train.kind.long": "Lungo",
  "train.kind.brick": "Combinata",
  "train.kind.race": "Gara",
  "train.focus.aerobicBase": "Base aerobica",
  "train.focus.gutTraining": "Allena l'intestino a {carb} g/h",
  "train.focus.raceRehearsal": "Prova gara a {carb} g/h",
  "train.focus.threshold": "Soglia",
  "train.focus.hills": "Salite",
  "train.focus.recovery": "Recupero",
  "train.focus.backToBack": "Due giorni lunghi, a gambe stanche",
  "train.focus.openerLegs": "Sveglia le gambe",
  "train.focus.raceDay": "Giorno di gara",
  "train.fuel.settleGut": "Abitua l'intestino — mangia nel lungo, senza forzare.",
  "train.fuel.buildRate": "Alza il ritmo di assunzione nel lungo, un po' ogni settimana.",
  "train.fuel.raceRate": "Ritmo gara, prodotti gara, a gambe stanche.",
  "train.fuel.holdRate": "Mantieni il ritmo che ti sei guadagnato.",
  "train.fuel.loadAndTaper": "L'allenamento cala, i carboidrati no.",
  "train.fuel.raceWeek": "Niente di nuovo. Carica nelle ultime 48 ore.",

  // ---- Training plan: per-session fuelling, stats, learnings --------------
  "train.prep": "Che cosa comporta questa preparazione",
  "train.prepSessions": "{n} sedute",
  "train.prepHours": "{n} h in totale",
  "train.prepRehearsals": "{n} prove a {carb} g/h",
  "train.prepCarb": "{n} g di carboidrati da provare",
  "train.prepFirstRaceRate": "Ritmo gara dalla settimana {n}",
  "train.learnings": "Che cosa significa per te",
  "train.sessionFuel": "Rifornimento",
  "train.pre": "Prima",
  "train.during": "Durante",
  "train.after": "Dopo",
  "train.preValue": "{carb} g di carboidrati 1–3 h prima, {fluid} ml di liquidi",
  "train.duringValue": "{carb} g/h · {fluid} ml/h · {sodium} mg di sodio/l · {feeds} assunzioni",
  "train.duringNone": "L'acqua basta — breve e leggera.",
  "train.afterValue": "{carb} g di carboidrati + {protein} g di proteine entro un'ora",
  "train.rehearsalTag": "prova",
  "train.learn.noLogsYet": "Registra un lungo e questo piano inizia a imparare: il ritmo che tolleri è quello verso cui dovrebbe costruire — ora lavora su medie di popolazione.",
  "train.learn.gutCeilingBelowTarget": "I tuoi dati ti collocano intorno a {ceiling} g/h e questa gara ne chiede {target} g/h. Sali piano nei lunghi invece di forzare, e registra cosa succede — dopo {samples} sedute quel tetto è una tua misura, non un'ipotesi.",
  "train.learn.belowTargetSoFar": "Il ritmo più alto che hai registrato è {best} g/h su {samples} sedute, e questa gara ne chiede {target} g/h. Nulla dice che non ci arriverai: i lunghi servono proprio a questo.",
  "train.learn.toleratesRate": "I tuoi dati mostrano già {rate} g/h senza problemi su {samples} sedute. Tieni quel ritmo nei lunghi e non cambiare altro.",
  "train.learn.underFuelling": "Ultimamente finisci le sedute a secco. Il piano aggiunge circa {bias} g/h nei lunghi.",
  "train.learn.fewRaceRateSessions": "Solo {sessions} dei tuoi lunghi arrivano al ritmo gara pieno — puntane {want}, altrimenti il giorno di gara sarà la prima volta per il tuo intestino.",
