...
export const de: Dictionary = {
  ...
  "plan.viewsLabel": "Welcher Teil des Plans",
  "plan.view.plan": "Der Plan",
  "plan.view.fuel": "Was mitnehmen",
  "plan.view.learn": "Details & Log",
  ...
  "log.samplesLogged": "{count} erfasst",
  "log.carbCeiling": "Obergrenze {n} g/h",
  "log.targetsUnchanged": "Zielwerte unverändert",
  ...
  "insights.milestonesAhead": "Noch {count} vor Ihnen",
  "insights.noSessions":
  ...
  "connect.brings": "Liefert {what}",
  "cap.activities": "Einheiten",
  "cap.heartRate": "Herzfrequenz",
  "cap.power": "Leistung",
  "cap.trainingLoad": "Trainingsbelastung",
  "cap.sleep": "Schlaf",
  ...
  "landing.title": "Deine Trainingsdaten, übersetzt in einen Verpflegungsplan",
  "landing.lede": "Garmin, Strava, Polar und Suunto messen, was du gemacht hast. Die Marken verkaufen, was du zu dir nimmst. Dazwischen fehlt die Schicht: Gramm pro Stunde, Milliliter, Natrium — berechnet für deinen Körper, deine Einheit und die Woche, die hinter dir liegt.",
  "landing.proofBody": "Gewicht, Herzfrequenz, gemessene Schweissrate und das Wetter — kein Bevölkerungsdurchschnitt.",
  "landing.proofLoad": "Deine letzten sechs Wochen Belastung prägen den Plan, nicht nur die heutige Einheit.",
  "landing.proofProducts": "Abgeglichen mit echten Produkten, die du in der Schweiz kaufen kannst — markenneutral.",
  "landing.providers": "Importiert von {count} Plattformen — Garmin, Strava, Polar und Suunto.",
  "landing.chainTitle": "Wo wir stehen",
  "landing.chainLede": "Die Wertschöpfungskette im Ausdauersport hat drei Glieder. Zwei davon sind bereits besetzt.",
  "landing.chainMeasure": "Messen",
  "landing.chainMeasureWhat": "Deine Uhr und die Plattformen dahinter",
  "landing.chainDecide": "Entscheiden",
  "landing.chainDecideWhat": "Was und wann du isst und trinkst — das sind wir",
  "landing.chainSupply": "Liefern",
  "landing.chainSupplyWhat": "Die Marken, die Gels und Getränke herstellen",
  "landing.offerTitle": "Was du bekommst",
  "landing.offerLede": "Vier Dinge, die die App heute wirklich kann.",
  "landing.offerPlanTitle": "Ein Plan in Gramm, nicht in Adjektiven",
  "landing.offerPlanBody": "Kohlenhydrate pro Stunde, Flüssigkeit pro Stunde und Natrium pro Liter für die Einheit vor dir — mit der Begründung, wenn du sie sehen willst.",
  "landing.offerCuesTitle": "Ein Zeitplan für unterwegs",
  "landing.offerCuesBody": "Getaktete Hinweise — 0:20, 15 g Kohlenhydrate, 140 ml — mit einer Uhr, die den jetzt fälligen hervorhebt.",
  "landing.offerRouteTitle": "Die Strecke, und was sie dich kostet",
  "landing.offerRouteBody": "Importiere ein GPX oder einen Schweizer Wettkampf: Anstiege, Hitze und Höhe verändern den Plan, und die Verpflegungsstellen liegen dort, wo die Arbeit ist.",
  "landing.offerLearnTitle": "Sie lernt, was dein Magen verträgt",
  "landing.offerLearnBody": "Halte fest, wie eine Einheit gelaufen ist, und die Zielwerte verschieben sich. Neunzig Gramm pro Stunde sind eine Obergrenze, keine Vorgabe.",
  "landing.engineTitle": "Woran die Engine rechnet",
  "landing.engineLede": "Zwei der Ideen hinter jedem Plan, aus denselben Zahlen, mit denen die App arbeitet.",
  "landing.curveTitle": "Verfügbare Kohlenhydrate über eine lange Einheit",
  "landing.curveAlt": "Ein Liniendiagramm: nach Plan verpflegt bleibt die Kurve oben, mit Wasser allein fällt sie unter die Grenze.",
  "landing.curveFuelled": "Nach Plan verpflegt",
  "landing.curveWater": "Nur Wasser",
  "landing.curveLimit": "Wo der Tank leer ist",
  "landing.ladderTitle": "Kohlenhydrate pro Stunde, nach Dauer",
  "landing.ladderShort": "Kurze Einheit, unter 45 Min.",
  "landing.ladderMid": "Bis 75 Min.",
  "landing.ladderLong": "Ein bis zweieinhalb Stunden",
  "landing.ladderUltra": "Über 2,5 Stunden",
  "landing.ladderNote": "Gramm pro Stunde. Die Grenze ist die Aufnahme, nicht der Wille — und sie lässt sich trainieren.",
  "landing.articlesTitle": "Ein Ratgeber, der die Zahlen nennt",
  "landing.articlesLede": "{count} Artikel: was zu tun ist, wie viel, was meistens schiefgeht und woher die Empfehlung stammt.",
  "landing.closeTitle": "Fang mit der Einheit von morgen an",
  "landing.closeBody": "Keine Karte, kein Verkaufsgespräch. Verbinde eine Plattform oder trage eine Einheit ein und sieh dir den Plan an.",
  "landing.closeCta": "Konto erstellen",
  "landing.footNoOperator": "Diese Installation nennt keinen Betreiber.",
  "landing.footNote": "Allgemeine Hinweise für gesunde Erwachsene, nach gängigem sporternährungswissenschaftlichem Konsens. Keine medizinische Beratung.",
