...
export const fr: Dictionary = {
  ...
  "plan.viewsLabel": "Quelle partie du plan",
  "plan.view.plan": "Le plan",
  "plan.view.fuel": "Quoi emporter",
  "plan.view.learn": "Détails & journal",
  "plan.house": "maison",
  ...
  "log.samplesLogged": "{count} enregistrées",
  "log.carbCeiling": "plafond {n} g/h",
  "log.targetsUnchanged": "cibles inchangées",
  ...
  "insights.milestonesAhead": "{count} encore à venir",
  "insights.noSessions":
  ...
  "insights.trendUp": "En progrès — {delta} points de plus sur vos dernières séances.",
  "insights.trendDown": "En baisse — {delta} points de moins récemment.",
  "insights.trendFlat": "Stable sur vos dernières séances.",
  ...
  "connect.brings": "Apporte {what}",
  "cap.activities": "séances",
  "cap.heartRate": "fréquence cardiaque",
  "cap.power": "puissance",
  "cap.trainingLoad": "charge d'entraînement",
  "cap.sleep": "sommeil",
  ...
  "landing.title": "Vos données d'entraînement, traduites en plan nutritionnel",
  "landing.lede": "Garmin, Strava, Polar et Suunto mesurent ce que vous avez fait. Les marques vendent ce que vous avalez. Entre les deux, il manque une couche : grammes par heure, millilitres, sodium — calculés pour votre corps, votre séance et la semaine que vous venez de vivre.",
  "landing.proofBody": "Poids, fréquence cardiaque, taux de sudation mesuré et météo — pas une moyenne de population.",
  "landing.proofLoad": "Vos six dernières semaines de charge façonnent le plan, pas seulement la séance du jour.",
  "landing.proofProducts": "Associé à de vrais produits achetables en Suisse, sans préférence de marque.",
  "landing.providers": "Importe depuis {count} plateformes — Garmin, Strava, Polar et Suunto.",
  "landing.chainTitle": "Notre place dans la chaîne",
  "landing.chainLede": "La chaîne de valeur de l'endurance compte trois maillons. Deux sont déjà occupés.",
  "landing.chainMeasure": "Mesurer",
  "landing.chainMeasureWhat": "Votre montre, et les plateformes derrière elle",
  "landing.chainDecide": "Décider",
  "landing.chainDecideWhat": "Quoi manger et boire, et quand — c'est nous",
  "landing.chainSupply": "Fournir",
  "landing.chainSupplyWhat": "Les marques qui fabriquent les gels et les boissons",
  "landing.offerTitle": "Ce que vous obtenez",
  "landing.offerLede": "Quatre choses que l'application fait réellement aujourd'hui.",
  "landing.offerPlanTitle": "Un plan en grammes, pas en adjectifs",
  "landing.offerPlanBody": "Glucides par heure, liquide par heure et sodium par litre pour la séance qui vous attend — avec le raisonnement, si vous le souhaitez.",
  "landing.offerCuesTitle": "Un horaire à suivre en pleine séance",
  "landing.offerCuesBody": "Des rappels minutés — 0:20, 15 g de glucides, 140 ml — avec une horloge qui met en évidence celui qui arrive.",
  "landing.offerRouteTitle": "Le parcours, et ce qu'il vous coûte",
  "landing.offerRouteBody": "Importez un GPX ou une course suisse : les montées, la chaleur et l'altitude modifient le plan, et les ravitaillements tombent là où se trouve l'effort.",
  "landing.offerLearnTitle": "Elle apprend ce que votre intestin tolère",
  "landing.offerLearnBody": "Notez comment s'est passée une séance et les cibles bougent. Quatre-vingt-dix grammes par heure est un plafond, pas une ordonnance.",
  "landing.engineTitle": "Ce que le moteur calcule",
  "landing.engineLede": "Deux des idées derrière chaque plan, tirées des chiffres mêmes que l'application utilise.",
  "landing.curveTitle": "Glucides disponibles sur une longue séance",
  "landing.curveAlt": "Un graphique linéaire : alimentée selon le plan la courbe reste haute, à l'eau seule elle passe sous la limite.",
  "landing.curveFuelled": "Alimenté selon le plan",
  "landing.curveWater": "Eau seule",
  "landing.curveLimit": "Quand le réservoir est vide",
  "landing.ladderTitle": "Glucides par heure, selon la durée",
  "landing.ladderShort": "Séance courte, moins de 45 min",
  "landing.ladderMid": "Jusqu'à 75 min",
  "landing.ladderLong": "D'une à deux heures et demie",
  "landing.ladderUltra": "Au-delà de 2 h 30",
  "landing.ladderNote": "Grammes par heure. La limite est l'absorption, pas la volonté — et elle s'entraîne.",
  "landing.articlesTitle": "Un guide qui donne les chiffres",
  "landing.articlesLede": "{count} articles : quoi faire, en quelle quantité, ce qui échoue le plus souvent et d'où vient la recommandation.",
  "landing.closeTitle": "Commencez par la séance de demain",
  "landing.closeBody": "Pas de carte bancaire, pas d'appel commercial. Connectez une plateforme ou saisissez une séance, et voyez le plan.",
  "landing.closeCta": "Créer votre compte",
  "landing.footNoOperator": "Ce déploiement n'a nommé aucun exploitant.",
  "landing.footNote": "Conseils généraux pour adultes en bonne santé, selon le consensus courant en nutrition sportive. Pas un avis médical.",
